...
@IBDesignable public class YokoTextField: TextFieldEffects {
    ...
    override public func animateViewsForTextEntry() {
        animateWithDuration(0.4, type: .TextEntry) { 
    ...
    override public func animateViewsForTextDisplay() {
        if text!.isEmpty {
            animateWithDuration(0.5, type: .TextDisplay) {
    ...
    private func animateWithDuration(duration: NSTimeInterval, type: AnimationType, animations: () -> ()) {
        let a1 = ViewAnimation(duration: duration, animations: animations)
        a1.spring = Spring(damping: 1.0, initialVelocity: 0.6)
