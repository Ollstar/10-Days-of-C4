...
@IBDesignable public class HoshiTextField: TextFieldEffects {
    ...
    override public func animateViewsForTextEntry() {
        ...
        if text!.isEmpty {
            animateWithDuration(0.3, withInitialVelocity: 1.0, forType: .TextEntry, action: { 
    ...
    override public func animateViewsForTextDisplay() {
        if text!.isEmpty {
            ...
            animateWithDuration(0.35, withInitialVelocity: 2.0, forType: .TextDisplay, action: { 
    ...
    private func animateWithDuration(duration: NSTimeInterval, withInitialVelocity initialVelocity: Double, forType type: AnimationType, action: () -> ()) {
        let a1 = ViewAnimation(duration: duration, animations: action)
        let spring = Spring(damping: 0.8, initialVelocity: initialVelocity)
        a1.spring = spring
